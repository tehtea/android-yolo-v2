...
public interface Config {
    ...
    int OUTPUT_WIDTH = 13;
    int OUTPUT_CHANNELS = 85;
    String MODEL_FILE = "binarized-model.dab";   // The filepath of the model GraphDef protocol buffer.
    String LABEL_FILE = "coco-labels.txt"; // The filepath of label file for classes.
